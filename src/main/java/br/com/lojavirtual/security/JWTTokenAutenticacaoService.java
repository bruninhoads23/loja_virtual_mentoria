...
public class JWTTokenAutenticacaoService {
	...
	private static final String HEADER_STRING = "Authorization";// para dar o retorno da requisição para pear na tela do
																// usuario
	...
	public void addAuthentication(HttpServletResponse response, String username) throws Exception {
		...
		/*
		 * retorna a resposta para tela e para o cliente, outra API, navegador,
		 * aplicativo, javascript, outra chamadajava
		 */
