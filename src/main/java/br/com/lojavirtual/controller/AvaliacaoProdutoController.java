...
public class AvaliacaoProdutoController {
	...
	public ResponseEntity<AvaliacaoProduto> salvarAvaliacaoProduto(@RequestBody @Valid AvaliacaoProduto avaliacaoProduto) throws ExceptionMentoriaJava{
		...
		/*Se a empresa é  NULL ou se o ID da empresa é passada, mas o ID  da empresa é menor que zero*/
		...
		/*Se a produto é  NULL ou se o ID da produto é passado, mas o ID  da produto é menor que zero*/
		...
		/*Se a pessoa é  NULL ou se o ID da pessoa é passado, mas o ID  da pessoa é menor que zero*/
	...
	public ResponseEntity<?> deleteAvalicaoPessoa(@PathVariable("idAvaliacao") Long idAvaliacao) { 
		...
		avaliacaoProdutoRepository.deleteAvaliacaoPorId(idAvaliacao);
